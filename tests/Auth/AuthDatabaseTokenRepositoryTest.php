...
class AuthDatabaseTokenRepositoryTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        return new Illuminate\Auth\Passwords\DatabaseTokenRepository(m::mock('Illuminate\Database\Connection'),  m::mock('Illuminate\Contracts\Hashing\Hasher'), 'table', 'key');
    }
}
